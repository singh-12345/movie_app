...
const CreateMovie = () => {
  ...
  return (
    <div className="container flex justify-center items-center mt-4 ">
      ...
      <form className="bg-cyan-900 rounded-xl">

        <p className="text-green-200 w-[50rem] text-2xl mb-4 text-center">Create Movie</p>
...
<div className="flex justify-center items-center">
        <button
          ...
          className="bg-indigo-500 text-white px-4 py-2 rounded mb-1"
