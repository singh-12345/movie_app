        ...
        <div className="p-3">
          ...
          <div className="flex flex-wrap justify-around items-center p-[2rem] ">
            {movies?.map((movie) => (
              ...
              >
                <div className="flex bg-cyan-700 rounded-2xl">
                  <div
                    key={movie._id}
                  ...
                  >
                    ...
                    <p className="text-black font-bold text-base">{movie.detail}</p>

                    <div className="mt-[2rem] mb-[1rem]">
                      <Link
                        to={`/admin/movies/update/${movie._id}`}
                        className="bg-indigo-800 hover:bg-teal-700 text-white font-bold py-2 px-4 rounded"
                      >
                        Update Movie
                      </Link>
                    </div>
