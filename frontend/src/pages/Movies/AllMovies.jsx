...
import {
  ...
  const AllMovies = () => {
    ...
    return (
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 -translate-y-[5rem] bg-cyan-900">
        <>
          <section>
            <div
            ...
            >
              ...
              <div className="relative z-10 text-center text-white mt-[10rem]">
                <h1 className="text-8xl font-bold mb-4">The Movie's Multiverse</h1>
                <p className="text-2xl">
                  Cinematic Galaxy: Unveiling the Magic of Movies
                </p>
              </div>
